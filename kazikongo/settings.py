"""
Django settings for kazikongo project.
...
SECRET_KEY = 'django-insecure-ztq!wz==v^8ypmz7q-q30tu+4v(#p)lqe59*$m0egmrlc6tg8s'
...
WSGI_APPLICATION = 'kazikongo.wsgi.application'
